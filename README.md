...
Basically this project is about bank management system, by which we create current and saving account of a customer and also maintain the customer account . this project is consist of eight functionality like NEW ACCOUNT, DEPOSIT AMOUNT, WITHDRAW AMOUNT, BALANCE ENQUIRY, ALL ACCOUNT HOLDER LIST, CLOSE AN ACCOUNT, MODIFY AN ACCOUNT, EXIT
